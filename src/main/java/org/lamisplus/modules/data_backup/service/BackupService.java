...
import org.lamisplus.modules.data_backup.config.ApplicationProperties;
import org.lamisplus.modules.data_backup.controller.JobSchedulerController;
import org.lamisplus.modules.data_backup.vm.ScheduleRequest;
...
public class BackupService {
    ...
    private final JobSchedulerController jobSchedulerController;

    private String username ="postgres";
    private String password ="emeka";
    private String database = "lamistest";
        ...
        try {
            ...
            if (file.exists()) {
                ...
                try {
                    ...
                    System.out.println("===> Success on  process.");
                } catch (Exception e) {
                    e.printStackTrace();
    ...
    public void init() {
        ...
        String jobClass = "org.lamisplus.modules.data_backup.service.BackupJob";
        boolean scheduled = jobSchedulerController.listJobClasses()
                .stream()
        ...
        if (!scheduled) {
            ...
            jobSchedulerController.scheduleJob(request);
        }
